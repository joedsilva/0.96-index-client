...
/**
 * Created by jdsilv2 on 17/08/16.
 */
public class TCHTIdxZipf01 extends TCZipf01
{

    protected static Log LOG = LogFactory.getLog(TCIdxZipf01.class);

    public TCHTIdxZipf01(int threadid) { super(threadid); }
